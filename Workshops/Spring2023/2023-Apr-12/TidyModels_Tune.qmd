...
**Note** that the original data are still modified as described in the previous article: [*Evaluate your model with resampling*](https://gchism.quarto.pub/tidymodels-evaluate-your-model-with-resampling/).
