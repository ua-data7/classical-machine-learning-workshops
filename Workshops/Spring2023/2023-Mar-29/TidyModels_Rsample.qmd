...
```
For our classification model to work, we need to take the original data and create factor variables for `Treatment` and `block`, and we need to make `Repro_culm` a numerical variable.
```{r read-data}
